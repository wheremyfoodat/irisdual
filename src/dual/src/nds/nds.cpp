...
namespace dual::nds {
  ...
  NDS::NDS() {
    m_arm9.cpu = std::make_unique<arm::ARM>(&m_arm9.bus, m_arm9.cycle_counter, arm::CPU::Model::ARM9);
    ...
    m_arm7.cpu = std::make_unique<arm::ARM>(&m_arm7.bus, m_arm7.cycle_counter, arm::CPU::Model::ARM7);
